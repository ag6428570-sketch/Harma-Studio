...
<body class="bg-darkBg text-gray-200 font-sans min-h-screen">
                ...
                <div class="p-6 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-start">
                    ...
                    <div class="flex-shrink-0 flex flex-col items-center space-y-4">
                        <div class="relative">
                            ...
                            <div class="absolute -bottom-2 -right-2 bg-green-500/30 rounded-full p-2 backdrop-blur-sm">
                                <i class="fa-solid fa-code-branch text-green-400"></i>
                            </div>
                        </div>
                        <div class="text-center">
                            <p class="font-mono text-blue-300 text-sm">✨ 首席开发者 ✨</p>
    ...
    <script>
        const taskData = { "tank": { title: "坦克任务", tasks: [{ name: "M3布拉德利", requirement: "花费 40 个坦克零件" },{ name: "威斯尔1MK20", requirement: "使用 15 次空投呼召" },{ name: "威斯尔1拖车Ⅱ型", requirement: "使用 1MK20 摧毁 20 辆地面载具" },{ name: "T72", requirement: "使用坦克击杀 30 人" },{ name: "ADATS", requirement: "摧毁 60 架飞行器" },{ name: "维塞尔1防空", requirement: "使用 1MK20 摧毁 20 辆地面载具" },{ name: "M1艾布拉姆斯", requirement: "使用坦克摧毁 30 辆坦克 & 偷取 10 个零件箱" },{ name: "K9雷霆SPG", requirement: "摧毁 60 辆地面载具 & 300 米外击杀 40 人" },{ name: "豹子2A7", requirement: "摧毁 35 辆坦克 & 驾驶 600 秒坦克" },{ name: "失败任务", requirement: "占领捕捉点 1800 秒 & 使用坦克 200 米外击杀 20 人" },{ name: "T90", requirement: "使用坦克摧毁 45 辆坦克 & 花费 100 个坦克零件" },{ name: "PL_01", requirement: "使用坦克摧毁 40 辆地面载具 & 驾驶 1500 秒坦克" },{ name: "MAUS", requirement: "坦克受到 10 万伤害 & 找到 4 个隐藏车辆部件" },{ name: "T14", requirement: "收集 10 桶石油 & 使用坦克 200 米外击杀 40 人 & 使用坦克击杀 75 人" },{ name: "挑战者Ⅱ黑色夜晚", requirement: "坦克受到 12 万伤害 & 收集 10 架坠毁的无人机 & 使用 50 次主动保护系统" },{ name: "KF_51豹子", requirement: "花费 200 个坦克零件 & 占领捕捉点 3000 秒 & 使用坦克击杀 100 人" }] }, "helicopter": { title: "直升机任务", tasks: [{ name: "UH60_黑鹰", requirement: "救起 10 个玩家" },{ name: "欧洲直升机老虎", requirement: "摧毁 40 辆车辆" },{ name: "无敌", requirement: "使用直升机摧毁 45 架直升机 & 驾驶直升机通过圆环获取 45 积分" },{ name: "AH_64阿帕奇", requirement: "使用直升机击杀 25 人 & 占领捕捉点 1500 秒" },{ name: "KA_52鳄鱼", requirement: "摧毁 30 架直升机 & 使用直升机 200 米外击杀 20 人" },{ name: "直10", requirement: "花费 100 个船舰零件 & 使用直升机对任何载具造成 5 万伤害" },{ name: "超级种马", requirement: "使用直升机摧毁 20 辆船舰 & 收集 5 桶石油" },{ name: "AH_1Z毒蛇", requirement: "使用直升机摧毁 50 辆地面载具 & 占领捕捉点 1200 秒" },{ name: "咆哮者X", requirement: "使用直升机摧毁 20 架飞机 & 使用直升机摧毁 20 辆车库车辆 & 驾驶直升机通过圆环获取 200 积分" },{ name: "A129芒果", requirement: "花费 200 个直升机零件 & 使用直升机摧毁 40 架飞机 & 使用直升机击杀 12 人" }] }, "airplane": { title: "飞机任务", tasks: [{ name: "B_29", requirement: "占领捕捉点 1800 秒" },{ name: "F_14", requirement: "使用飞机摧毁 30 架直升机" },{ name: "Ju57斯图卡", requirement: "使用飞机摧毁 15 辆坦克" },{ name: "F_4", requirement: "使用飞机击杀 30 人" },{ name: "米格_29", requirement: "使用飞机摧毁 25 架飞机" },{ name: "A_10", requirement: "使用飞机摧毁 50 辆地面载具 & 飞机受到 4 万伤害" },{ name: "JAS_39", requirement: "占领捕捉点 1800 秒 & 使用飞机击杀 50 人" },{ name: "F_15E", requirement: "使用飞机摧毁 60 辆地面载具 & 使用飞机 200 米外击杀 40 人" },{ name: "F_18", requirement: "使用飞机摧毁 40 辆船舰 & 花费 100 个飞机零件" },{ name: "苏57", requirement: "花费 100 个飞机零件 & 使用飞机摧毁 30 架飞机" },{ name: "欧洲战斗机台风", requirement: "使用飞机摧毁车辆 & 偷取 5 个零件箱" },{ name: "阵风", requirement: "使用飞机摧毁 20 辆船舰 & 使用飞机摧毁 60 架飞行器" },{ name: "F_16", requirement: "摧毁 30 架飞机 & 花费 60 个飞机零件" },{ name: "F_22", requirement: "驾驶飞机通过圆环收集 400 积分 & 占领捕捉点 1800 秒 & 使用飞机击杀 100 人" },{ name: "夜鹰", requirement: "使用飞机炸弹击杀 25 人 & 占领捕捉点 1800 秒 & 偷取 10 个零件箱" },{ name: "黑暗之星", requirement: "花费 10 个升级点数 & 偷取 10 个零件箱 & 收集 10 架坠毁的无人机" },{ name: "歼36", requirement: "收集 10 架坠毁的无人机 & 使用飞机摧毁 20 辆船舰 & 花费 100 个飞机零件" }] }, "hovercraft": { title: "悬空载具", tasks: [{ name: "PACV_78突击", requirement: "使用气垫船摧毁 40 辆地面载具" },{ name: "PACV_77风镰", requirement: "使用气垫船摧毁 30 架飞行器" },{ name: "QBZ_95", requirement: "使用自动武器 50 米外击杀 30 人" },{ name: "C4", requirement: "使用手榴弹击杀 15 人 & 摧毁 10 辆地面车辆" },{ name: "QBJ_LMG", requirement: "偷取 10 个零件箱 & 使用自动武器击杀 20 人" },{ name: "AVH猎人", requirement: "使用气垫船摧毁 60 辆地面载具 & 使用气垫船撞倒 300 物品 & 驾驶气垫船 1800 秒" }] }, "ship": { title: "船舰与潜艇", tasks: [{ name: "PG02", requirement: "使用船舰击杀 25 人" },{ name: "法尔米尔", requirement: "收集 10 桶海洋沉船石油" },{ name: "KSG_12", requirement: "使用夹弹枪击杀 20 人 & 收集 4 桶石油" },{ name: "道格拉斯号", requirement: "使用船舰摧毁 40 辆载具 & 占领捕捉点 1800 秒" },{ name: "PP_19Bizon", requirement: "使用自动武器击杀 25 人 & 偷取 2 个零件箱" },{ name: "Pr.206", requirement: "使用船舰摧毁 20 辆敌方船舰" },{ name: "USS独立号", requirement: "使用船舰摧毁 125 辆载具或者船舰 & 占领捕捉点 1500 秒 & 收集 10 桶石油" }] } };
        let trackedTasks = JSON.parse(localStorage.getItem('wtt_tracked')) || [];
        let activeModalTask = null;
        window.addEventListener('DOMContentLoaded', () => { renderTaskSections(); updateTrackerBadge(); });
        function searchTasks() { const input = document.getElementById('search-input'); const infoText = document.getElementById('search-results-info'); const social = document.getElementById('social-section'); const divider = document.getElementById('section-divider'); const factionHr = document.getElementById('faction-hr'); const factionSec = document.getElementById('faction-section'); const aboutHr = document.getElementById('about-hr'); const aboutSec = document.getElementById('aboutus-section'); const val = input.value.trim(); const isFiltering = val !== ""; const extraElements = [factionHr, factionSec, aboutHr, aboutSec]; if (isFiltering) { if(social) social.style.display = 'none'; if(divider) divider.style.display = 'none'; extraElements.forEach(el => { if(el) el.style.display = 'none'; }); infoText.classList.remove('hidden'); } else { if(social) social.style.display = 'block'; if(divider) divider.style.display = 'block'; extraElements.forEach(el => { if(el) el.style.display = 'block'; }); infoText.classList.add('hidden'); } renderTaskSections(input.value); }
        function renderTaskSections(filterText = "") { const container = document.getElementById('tasks-container'); const categorySelector = document.getElementById('category-selector'); const sectionDivider = document.getElementById('section-divider'); container.innerHTML = ''; const filter = filterText.trim().toLowerCase(); if (filter === "") { categorySelector.classList.remove('hidden'); if(sectionDivider) sectionDivider.classList.remove('hidden'); Object.keys(taskData).forEach(key => { const category = taskData[key]; const section = document.createElement('section'); section.id = `${key}-section`; section.className = "space-y-4 scroll-mt-20"; section.innerHTML = `<div class="border-b border-gray-800 pb-2"><h2 class="text-xl font-bold text-white flex items-center gap-2"><span class="w-1 h-5 bg-blue-500 rounded-full"></span>${category.title}</h2></div><div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">${category.tasks.map((task, index) => { const isTracked = trackedTasks.some(t => t.name === task.name); return `<div onclick="openTaskDetail('${key}', ${index})" class="p-4 rounded-xl border transition-all duration-200 cursor-pointer flex flex-col justify-between h-36 bg-darkCard border-gray-800 hover:border-blue-500/50"><div class="flex justify-between items-start"><span class="text-xs text-blue-400 font-medium bg-blue-500/10 px-1.5 py-0.5 rounded">载具/装备</span></div><h4 class="text-sm font-bold text-white truncate my-2">${task.name}</h4><div class="flex justify-between items-center text-xs text-gray-500 pt-2 border-t border-gray-800/60"><span>点击查看 →</span>${isTracked ? '<span class="text-[10px] text-green-400 bg-green-500/10 px-1.5 py-0.5 rounded">追踪中</span>' : ''}</div></div>`; }).join('')}</div>`; container.appendChild(section); }); } else { categorySelector.classList.add('hidden'); if(sectionDivider) sectionDivider.classList.add('hidden'); let totalMatches = 0; Object.keys(taskData).forEach(key => { const category = taskData[key]; const filteredTasks = category.tasks.map((t, idx) => ({...t, originalIndex: idx})).filter(t => t.name.toLowerCase().includes(filter)); if(filteredTasks.length > 0){ totalMatches += filteredTasks.length; const section = document.createElement('section'); section.className = "space-y-4"; section.innerHTML = `<div class="border-b border-gray-800 pb-2"><h2 class="text-lg font-bold text-white">${category.title}</h2></div><div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">${filteredTasks.map(task => { const isTracked = trackedTasks.some(t => t.name === task.name); return `<div onclick="openTaskDetail('${key}', ${task.originalIndex})" class="p-4 rounded-xl border transition-all duration-200 cursor-pointer flex flex-col justify-between h-36 bg-darkCard border-gray-800 hover:border-blue-500/50"><div class="flex justify-between items-start"><span class="text-xs text-blue-400 font-medium bg-blue-500/10 px-1.5 py-0.5 rounded">载具/装备</span></div><h4 class="text-sm font-bold text-white truncate my-2">${task.name}</h4><div class="flex justify-between items-center text-xs text-gray-500 pt-2 border-t border-gray-800/60"><span>点击查看 →</span>${isTracked ? '<span class="text-[10px] text-green-400 bg-green-500/10 px-1.5 py-0.5 rounded">追踪中</span>' : ''}</div></div>`; }).join('')}</div>`; container.appendChild(section); } }); const infoText = document.getElementById('search-results-info'); infoText.classList.remove('hidden'); infoText.innerText = `找到 ${totalMatches} 个名称相符项目`; } }
