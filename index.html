...
<body>
    ...
    <div id="main-app" style="display: none;">
        ...
        <header class="relative pt-10 pb-6 px-4 text-center">
            <div class="max-w-3xl mx-auto space-y-3 title-scale">
        ...
        <main class="max-w-6xl mx-auto px-4 mt-2 space-y-10">
            ...
            <section id="category-selector" class="space-y-4">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                    <div onclick="scrollToSection('tank-section'); unlockAchievement('tank_category')" class="rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 p-4 cursor-pointer category-card"><div class="text-white"><h3 class="text-lg font-black">坦克任务</h3><p class="text-blue-100 text-xs">16 个项目</p></div></div>
                    <div onclick="scrollToSection('helicopter-section'); unlockAchievement('helicopter_category')" class="rounded-2xl bg-gradient-to-br from-purple-600 to-violet-700 p-4 cursor-pointer category-card"><div class="text-white"><h3 class="text-lg font-black">直升机任务</h3><p class="text-purple-100 text-xs">10 个项目</p></div></div>
                    <div onclick="scrollToSection('airplane-section'); unlockAchievement('airplane_category')" class="rounded-2xl bg-gradient-to-br from-pink-600 to-rose-700 p-4 cursor-pointer category-card"><div class="text-white"><h3 class="text-lg font-black">飞机任务</h3><p class="text-pink-100 text-xs">17 个项目</p></div></div>
                    <div onclick="scrollToSection('hovercraft-section'); unlockAchievement('hovercraft_category')" class="rounded-2xl bg-gradient-to-br from-cyan-600 to-teal-700 p-4 cursor-pointer category-card"><div class="text-white"><h3 class="text-lg font-black">悬空载具</h3><p class="text-cyan-100 text-xs">6 个项目</p></div></div>
                    <div onclick="scrollToSection('ship-section'); unlockAchievement('ship_category')" class="rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-850 p-4 cursor-pointer category-card"><div class="text-white"><h3 class="text-lg font-black">船舰与潜艇</h3><p class="text-emerald-100 text-xs">7 个项目</p></div></div>
                </div>
            ...
            <section id="social-section" class="max-w-xl space-y-4">
                ...
                <div class="space-y-3">
                    <a href="https://roblox.com/join/y54bw" target="_blank" class="social-link-card social-slide"><i class="fa-solid fa-gamepad mr-4 text-blue-500 text-xl"></i> War Tycoon (Roblox)</a>
                    <a href="https://discord.gg/nFeyYDySug" target="_blank" class="social-link-card social-slide"><i class="fa-brands fa-discord mr-4 text-indigo-400 text-xl"></i> Discord</a>
                    <a href="https://tiktok.com/@wartycoon" target="_blank" class="social-link-card social-slide"><i class="fa-brands fa-tiktok mr-4 text-pink-500 text-xl"></i> Tik Tok</a>
                    <a href="https://x.com/WarTycoonRBLX" target="_blank" class="social-link-card social-slide"><i class="fa-brands fa-x-twitter mr-4 text-white text-xl"></i> X (Twitter)</a>
                    <a href="https://www.youtube.com/@WarTycoonRBLX" target="_blank" class="social-link-card social-slide"><i class="fa-brands fa-youtube mr-4 text-red-500 text-xl"></i> YouTube</a>
                </div>
            </section>
            ...
            <section id="faction-section" class="glass-card p-5 md:p-6 space-y-5">
                ...
                <div class="history-scroll max-h-[480px] overflow-y-auto pr-2 rounded-lg history-content">
            ...
            <section id="aboutus-section" class="glass-card p-5 md:p-6">
                ...
                <div class="space-y-4 text-gray-300">
                    <p class="about-item bg-black/20 rounded-xl p-4 border-l-4 border-blue-500 text-sm leading-relaxed">✿ <span class="font-bold text-blue-300">2026.05.26</span> 管理员濠制作了派系网页2.0 (重制版)，墨墨决定重新更新派系网页。<br>因1.0的经验，2.0的功能将更加全面，同时档案大小也是指数增加，我们将推翻旧的UI设计，制定一个全新的UI以及动画设计等，理想情况会加入注册登录功能。<br>后续我们团队会想办法将其弄成软件或网站，敬请期待 ✨<br>如果你也想为这个做贡献，就加入我们 Harma工作室™️ 吧！</p>
                    <div class="flex flex-wrap gap-3 text-sm font-mono about-item"><span class="bg-pink-500/10 text-pink-300 px-3 py-1 rounded-full text-xs">💖 “If you love Harma, I love you!”</span><span class="bg-amber-500/10 text-amber-300 px-3 py-1 rounded-full text-xs">🍑 “If you love Momo, I love you!”</span></div>
                    <div class="pt-2 space-y-1 text-sm border-t border-gray-700/70 mt-3 about-item"><p class="flex items-center gap-2"><i class="fa-regular fa-copyright text-gray-400"></i> <strong>Harma工作室™️</strong> ‖ 版权归 Harma™️ 所有</p><p class="text-gray-400 text-xs">Harma工作室™️ [前蓝狐(Blue Fox工作室™️)]</p>
                    ...
                    <p class="text-xs text-gray-500 text-right italic about-item">「千年王朝之梦，战火淬炼新生」</p>
                </div>
            </section>
