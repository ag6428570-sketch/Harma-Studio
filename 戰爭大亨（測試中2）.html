        ...
        <header class="relative pt-10 pb-6 px-4 text-center">
            ...
            <div class="max-w-md mx-auto mt-6 px-2">
                <div class="flex items-center gap-2">
                    <input type="text" id="search-input" oninput="searchTasks()" placeholder="输入「任务/载具名称」进行精确搜索..." class="w-full bg-darkCard border border-gray-700 rounded-xl py-3 px-4 text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500">
                    <button onclick="showEasterEggPage(); unlockAchievement('easter_egg')" class="bg-gradient-to-r from-amber-500/20 to-orange-500/20 hover:from-amber-500/40 hover:to-orange-500/40 border border-amber-500/50 rounded-xl py-3 px-4"><i class="fa-solid fa-dragon text-amber-400 text-xl"></i></button>
                </div>
        ...
        <main class="max-w-6xl mx-auto px-4 mt-2 space-y-10">
            ...
            <section id="category-selector" class="space-y-4">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                    <div onclick="scrollToSection('tank-section'); unlockAchievement('tank_category')" class="rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 p-4 cursor-pointer hover:-translate-y-1 transition"><div class="text-white"><h3 class="text-lg font-black">坦克任务</h3><p class="text-xs opacity-90">16 个项目</p></div></div>
                    <div onclick="scrollToSection('helicopter-section'); unlockAchievement('helicopter_category')" class="rounded-2xl bg-gradient-to-br from-purple-600 to-violet-700 p-4 cursor-pointer hover:-translate-y-1 transition"><div class="text-white"><h3 class="text-lg font-black">直升机任务</h3><p class="text-xs opacity-90">10 个项目</p></div></div>
                    <div onclick="scrollToSection('airplane-section'); unlockAchievement('airplane_category')" class="rounded-2xl bg-gradient-to-br from-pink-600 to-rose-700 p-4 cursor-pointer hover:-translate-y-1 transition"><div class="text-white"><h3 class="text-lg font-black">飞机任务</h3><p class="text-xs opacity-90">17 个项目</p></div></div>
                    <div onclick="scrollToSection('hovercraft-section'); unlockAchievement('hovercraft_category')" class="rounded-2xl bg-gradient-to-br from-cyan-600 to-teal-700 p-4 cursor-pointer hover:-translate-y-1 transition"><div class="text-white"><h3 class="text-lg font-black">悬空载具</h3><p class="text-xs opacity-90">6 个项目</p></div></div>
                    <div onclick="scrollToSection('ship-section'); unlockAchievement('ship_category')" class="rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-850 p-4 cursor-pointer hover:-translate-y-1 transition"><div class="text-white"><h3 class="text-lg font-black">船舰与潜艇</h3><p class="text-xs opacity-90">7 个项目</p></div></div>
                </div>
                <div class="mt-4"><a href="https://wttd.trade/" target="_blank" onclick="unlockAchievement('trade_market')" class="block rounded-2xl bg-gradient-to-br from-slate-700 to-slate-900 p-4 text-center max-w-xs"><h3 class="text-lg font-black text-white">⚔ 交易市场 (wttd.trade)</h3></a></div>
            </section>
